"""
Modifies copies of the original raw data files and updates it with the data obtained from
simulation NTT_1190_sufx.
"""
import numpy as np
...
basedir = '/data/staff/nanomax/reblex/data-simulated-recons/NTT_scan_001190/simulated_data/'
...
simdata_fname = basedir + 'NTT_1190_'+sufx+'/data/data_scan_001190.ptyd'
...
io.h5write(basedir + 'sim_files_'+sufx+'/001190.h5', h5_mod)
...
f = h5py.File(basedir + 'sim_files_'+sufx+'/scan_001190_eiger4m.hdf5', 'w')
